...
<template>
  <form class="container" @submit.prevent="handleapp()">
    <section class="client-form">
      ...
      <label for="cant-inp" class="input-container">
        <ion-icon name="call"></ion-icon>
        <input
          v-model="phones_count"
          type="number"
          placeholder="CANTIDAD DISPOSITIVOS"
          min="1"
          max="5"
          id="cant-inp"
        />
    ...
    <section class="bill-form">
      <label class="input-container">
        ...
        <span
          >TOTAL FACTURA: $ <span>{{ formattedBillTotal }}</span></span
        >
      </label>
      ...
      <label class="input-container">
        ...
        <span
          >PENDIENTE A PAGAR: $
          <span>{{ formatNumber(pendingAmount) }}</span></span
        >
      </label>
